...
const vaderTexture = new THREE.TextureLoader().load('vader.png');

const vader = new THREE.Mesh(
  new THREE.BoxGeometry(3,3,3),
  new THREE.MeshBasicMaterial({map: vaderTexture})
);
...
function moveCamera() {
  ...
  vader.rotation.y += 0.01;
  vader.rotation.z += 0.01;
